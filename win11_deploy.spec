...
project_file = spot_detector.pyproject

# application icon
icon = spot_detector/resources/icons/app_icon/spot_detector_logo_small.ico

[python]

# python path
python_path = C:\Users\louis\Documents\GitHub\spot-detector\venv\Scripts\python.exe
